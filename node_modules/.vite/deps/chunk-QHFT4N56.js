...
async function r(t, e, n) {
  ...
  if (!(await import("./intersectsOperator-YV5C3LK6.js")).execute(e, n)) return new c({ pixelType: t.pixelType, width: a2, height: r2, mask: x2, maskIsAlpha: false, pixels: [...t.pixels] });
  if ("polyline" === n.type) return s(t, e, n);
  return (await import("./containsOperator-7NO2XMEJ.js")).execute(n, e) ? t : o(t, e, n);
}
function o(t, e, n) {
  if (!t) return t;
...
//# sourceMappingURL=chunk-QHFT4N56.js.map
