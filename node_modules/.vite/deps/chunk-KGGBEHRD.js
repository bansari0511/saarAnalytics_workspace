...
function G(G2) {
  "async" === G2.mode && (G2.functions.disjoint = function(n, t2) {
    ...
    return G2.standardFunctionAsync(n, t2, (async (a3, s2, c2) => {
      ...
      if (!(l2 instanceof c)) throw new a(n, r.InvalidParameter, t2);
      if (true === l2.hasZ) {
        const { convertFromSpatialReferenceUnit: n2, toLengthUnit: t3 } = await import("./unitConversion-52P7M47H.js"), e = I(l2);
...
//# sourceMappingURL=chunk-KGGBEHRD.js.map
