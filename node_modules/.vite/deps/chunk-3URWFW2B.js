...
async function o2(o3) {
  const a2 = "portalItem" in o3 ? o3 : { portalItem: o3 }, { fromItem: e } = await import("./portalLayers-RRCCRY47.js");
  try {
    return await e(a2);
  } catch (p2) {
...
var h = class extends o.EventedMixin(n.IdentifiableMixin(p)) {
  ...
  static async fromArcGISServerUrl(e) {
    ...
    return (await import("./arcgisLayers-V7OQEIKX.js")).fromUrl(t);
  }
...
//# sourceMappingURL=chunk-3URWFW2B.js.map
