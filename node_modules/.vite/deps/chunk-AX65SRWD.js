...
async function C(e3) {
  const { computeObjectLayerResourceSize: t } = await import("./symbolLayerUtils-6RGL6S5R.js"), r = await t(e3, 10), { width: o, height: n2, depth: l3 } = e3, i3 = [o, l3, n2];
  let c2 = 1;
  for (let s = 0; s < 3; s++) {
    const e4 = i3[s];
    if (null != e4) {
...
//# sourceMappingURL=chunk-AX65SRWD.js.map
