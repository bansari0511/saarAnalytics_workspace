  ...
  switch (e16) {
    ...
    case "feature-record-set-layer":
      ...
      if ("layerDefinition" in t21) {
        const e17 = new (0, (await import("./FeatureLayer-OXUDZSMH.js")).default)(), { layerDefinition: a9, featureSet: n7 } = t21;
...
var g3 = (_a = class extends l {
  ...
  async fetchResultMapImageLayer() {
    ...
    return new (0, (await import("./MapImageLayer-AKEMDTKT.js")).default)({ url: t21 });
  }
...
r([m3({ type: Date, json: { type: Number, write: { writer: (e16, t21) => {
...
async function o4(s10) {
  if (s10) {
    const { default: s11 } = await import("./arcgis-knowledge-client-core-simd-QOEX3MPD.js").then(((e16) => e16.a));
    return s11({ locateFile: (s12) => n(t7 + s12) });
  }
  const { default: n7 } = await import("./arcgis-knowledge-client-core-BIWGMQVO.js").then(((e16) => e16.a));
...
r([m3()], e15.prototype, "hasError", void 0), r([m3()], e15.prototype, "error", void 0), r([m3()], e15.prototype, "editResults", void 0), e15 = r([a("esri.rest.knowledgeGraph.GraphApplyEditsResult")], e15);
var p16 = e15;
...
//# sourceMappingURL=chunk-BO6MPGQB.js.map
