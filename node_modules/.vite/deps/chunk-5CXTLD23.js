...
var c = class extends b {
  ...
  async update(t, r2) {
    const { addOrUpdateResources: e2 } = await import("./resourceUtils-256N4CKQ.js");
...
var k = v = class extends l2.JSONSupportMixin(p) {
  ...
  async fetchResources(e2 = {}, t) {
    const { fetchResources: i2 } = await import("./resourceUtils-256N4CKQ.js");
    return i2(this, e2, t);
  }
  async addResource(e2, t, i2) {
    const { addOrUpdateResources: r2 } = await import("./resourceUtils-256N4CKQ.js");
  ...
  async removeResource(e2, t) {
    const { removeResource: r2 } = await import("./resourceUtils-256N4CKQ.js");
  ...
  async removeAllResources(e2) {
    const { removeAllResources: t } = await import("./resourceUtils-256N4CKQ.js");
    return t(this, e2);
  }
  resourceFromPath(e2) {
...
//# sourceMappingURL=chunk-5CXTLD23.js.map
