...
var m5 = class extends $ {
  ...
  async _updateClipGeometry() {
    ...
    if (e2 && "inside" === t2.clippingType) {
      const { extent: t3 } = this.rasterInfo, r6 = await import("./densifyOperator-WBXUH2FX.js"), s3 = await import("./differenceOperator-HXNSJNAC.js");
    ...
    async _getSampleLocations(e2) {
      ...
      if ("polyline" === r6) {
        ...
        if (e2.sampleCount || e2.sampleDistance) {
          const i7 = await import("./densifyOperator-WBXUH2FX.js"), s4 = (await import("./lengthOperator-V32GXBFH.js")).execute(t2, { unit: "meters" }), n3 = Math.min(e2.sampleCount || 100, Q3);
...
//# sourceMappingURL=chunk-L6U3HWP2.js.map
