...
var P = class extends b {
  ...
  _loadSourceModule(e2) {
    ...
    switch (e2) {
      case "featureService":
        return t.addPromise(import("./FeatureServiceSnappingSource-PQ3C2AHB.js"));
      case "featureCollection":
        return t.addPromise(import("./FeatureCollectionSnappingSource-2R2V6FFF.js"));
      case "graphics":
      case "notes":
        return t.addPromise(import("./GraphicsSnappingSource-23QNLTAP.js"));
      case "scene":
        return t.addPromise(import("./SceneLayerSnappingSource-LE2O4YE7.js"));
    }
  }
  get test() {
  }
...
//# sourceMappingURL=FeatureSnappingEngine-3P2Q7UH7.js.map
