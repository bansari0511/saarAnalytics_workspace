...
import {
  ...
  t,
  z
} from "./chunk-DRYECZ76.js";
import {
  c as c6,
  l as l6,
  l2 as l7,
  r as r3
} from "./chunk-E6R2UEZ2.js";
import {
  g as g2,
  g2 as g3
} from "./chunk-OZVM5MKJ.js";
import {
  n as n5,
  p as p4,
  s as s5
} from "./chunk-QZTJHKG6.js";
import "./chunk-W5CL56LA.js";
import {
  p as p3
} from "./chunk-K4LQ6UIZ.js";
import "./chunk-VVE6POCY.js";
import "./chunk-AP7A45V5.js";
import {
  r as r8
} from "./chunk-S4RXMKI3.js";
import "./chunk-IE6QJMDY.js";
import {
  r as r9
} from "./chunk-MBYJSSL3.js";
import {
  r as r6
} from "./chunk-3V5RGETH.js";
import {
  r as r7
} from "./chunk-UCYV7RFO.js";
import "./chunk-3KDNHMA3.js";
import {
  E as E3,
  N,
  g
} from "./chunk-6YFGMLVH.js";
import {
  E,
  E2,
  h as h5,
...
import {
  m as m4,
  u as u3
} from "./chunk-NXY7NRQW.js";
import {
  m as m3
} from "./chunk-2BKRWNDZ.js";
...
var x3 = class extends o.EventedMixin(b) {
  ...
  async _createSelfSnappingEngine(e6) {
    const [{ SelfSnappingEngine: t3 }, n10] = await Promise.all([import("./SelfSnappingEngine-KD3Z7BJ4.js"), g4()]);
  ...
  async _createGridSnappingEngine(e6) {
    ...
    const { GridSnappingEngine: n10 } = await import("./GridSnappingEngine-MW75D2GH.js");
    return s2(e6), { type: "grid", engine: new n10({ view: t3, options: this.options }) };
  }
  async _createFeatureSnappingEngine(e6) {
    const { FeatureSnappingEngine: t3 } = await import("./FeatureSnappingEngine-3P2Q7UH7.js");
    s2(e6);
...
async function o4() {
  const e6 = await import("./geometryEngine-573MLASV.js");
  return s6(e6);
}
function n6(t3) {
...
var re = class extends o.EventedAccessor {
  ...
  initialize() {
    this.addHandles([a2((() => this.view?.map?.layers), "change", ((e6) => {
      ...
      this._defaultSnappingManager = u(this._defaultSnappingManager), e6 && (this.snappingManager || (this._defaultSnappingManager = new x3({ view: e6, options: this.snappingOptions })), "2d" === e6.type ? import("./editingTools-AWN5TKDJ.js") : "3d" === e6.type && (import("./editingTools-4V3XD5NW.js"), import("./GraphicsLayerView3D-5SUCGNMB.js")));
  ...
  async _makeDrawGraphicTool2D(e6) {
    const [t3, o6, i4] = await Promise.all([this._requireModule(import("./editingTools-AWN5TKDJ.js")), u5(), c8()]);
  ...
  async _makeDrawGraphicTool3D(e6) {
    const [t3, o6, i4] = await Promise.all([this._requireModule(import("./editingTools-4V3XD5NW.js")), u5(), c8()]);
  ...
  async _setupMove3DOperation(e6, t3, o6, i4, s8 = false) {
    const [r12, n10] = await Promise.all([this._requireModule(import("./editingTools-4V3XD5NW.js")), c8()]);
  ...
  async _setupPointTransform3DOperation(e6, t3, o6) {
    const i4 = "transform", { enableRotation: s8, enableScaling: r12, enableZ: n10 } = t3, p8 = await this._requireModule(import("./editingTools-4V3XD5NW.js"));
    if (ge(p8)) return p8;
  ...
  async _setupPolyTransform3DOperation(e6, t3, o6, i4 = false) {
    const s8 = "transform", { enableRotation: r12, enableScaling: n10, enableZ: p8, preserveAspectRatio: l9 } = t3, [h8, c9] = await Promise.all([this._requireModule(import("./editingTools-4V3XD5NW.js")), c8()]);
    if (ge(h8)) return h8;
  ...
  async _setupReshape3DOperation(e6, t3, o6, i4 = false) {
    const s8 = "reshape", [r12, n10, p8] = await Promise.all([this._requireModule(import("./editingTools-4V3XD5NW.js")), u5(), c8()]);
    if (ge(r12)) return r12;
  ...
  async _getGraphicMover(e6, t3, o6) {
    const { enableMoveAllGraphics: i4, highlightOptions: a8 } = t3, s8 = await this._requireModule(import("./GraphicMover-H2KVTR74.js"));
  ...
  async _getBox(e6, t3, o6) {
    const { enableRotation: i4, enableScaling: a8, highlightOptions: s8, preserveAspectRatio: r12 } = t3, [n10, p8] = await Promise.all([this._requireModule(import("./Box-ASD6CBUJ.js")), c8()]);
  ...
  async _getReshape(e6, t3, o6) {
    const { highlightOptions: i4, reshapeOptions: a8 } = t3, s8 = "split" === a8?.edgeOperation, r12 = "move" === a8?.shapeOperation, [n10, p8, l9] = await Promise.all([this._requireModule(import("./Reshape-TKYHR7J7.js")), u5(), c8()]);
...
//# sourceMappingURL=RouteLayerInteraction-VA4AVVIO.js.map
