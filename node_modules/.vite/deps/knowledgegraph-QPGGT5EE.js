...
import {
  l
} from "./chunk-ZH2ZF5VV.js";
import {
  t
} from "./chunk-VKIF2UIR.js";
import {
  j as j2
...
async function M(e3, r2) {
  ...
  return await t2.load(), null === N && (N = await import("./knowledgeGraphService-V2GP7FWS.js")), await N.fetchKnowledgeGraph(t2.url);
}
...
function V(e3) {
  "async" === e3.mode && (e3.functions.knowledgegraphbyportalitem = function(t2, s3) {
    ...
    return e3.standardFunctionAsync(r2, i2, (async (e4, c3, f2) => {
      ...
      null === N && (N = await import("./knowledgeGraphService-V2GP7FWS.js"));
      let d = null;
      const h = q(f2[2], null);
...
//# sourceMappingURL=knowledgegraph-QPGGT5EE.js.map
