...
var z2 = class extends p3(a4(e(d(c(p2(c2(e2(t(f2(b(j(S(h))))))))))))) {
  ...
  async applyEdits(e3, t2) {
    const { applyEdits: r2 } = await import("./editingSupport-GDTVMEUG.js");
    await this.load();
  ...
  async queryAttributeBins(e3, t2) {
    ...
    const o = await import("./AttributeBinsQuery-XCOC5ABF.js"), s4 = await r2.queryAttributeBins(o.default.from(e3), t2);
...
//# sourceMappingURL=GeoJSONLayer-BXBVTPFE.js.map
