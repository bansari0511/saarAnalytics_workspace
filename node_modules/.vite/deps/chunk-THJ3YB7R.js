...
async function u() {
  if (!s2()) {
    const [e, t] = await Promise.all([import("./OperatorGeodesicBuffer-SQAVYTPB.js"), import("./ProjectionTransformation-KQYFEJZJ.js").then(((e2) => e2.aG)).then((({ injectPe: e2 }) => e2)), _()]);
...
//# sourceMappingURL=chunk-THJ3YB7R.js.map
