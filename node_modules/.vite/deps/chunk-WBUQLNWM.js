...
async function f5(e5, t5, n5) {
  const { source: o4 } = t5, { loadGLTFMesh: i6 } = await h(import("./loadGLTFMesh-NEXQOQWK.js"), n5), l4 = await p4(o4, n5);
  s2(n5);
...
var q2 = H2 = class extends p.LoadableMixin(m3.EsriPromiseMixin(c2)) {
  ...
  async toBinaryGLTF(e5) {
    const [{ toBinaryGLTF: t5 }] = await Promise.all([import("./gltfexport-VZ4GPLTB.js"), this.load(e5)]);
  ...
  static async createFromGLTF(e5, t5, r5) {
    ...
    const { loadGLTFMesh: s4 } = await h(import("./loadGLTFMesh-NEXQOQWK.js"), r5);
...
//# sourceMappingURL=chunk-WBUQLNWM.js.map
