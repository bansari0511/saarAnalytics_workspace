...
import {
  l,
  n
} from "./chunk-KVCNEGMZ.js";
import {
  o
} from "./chunk-IYBFICHV.js";
import {
  E,
  c,
  l as l2,
...
async function H(e) {
  ...
  e.forEach((({ type: e2 }) => {
    switch (l(e2)) {
      case "CatalogLayer":
        r.push(import("./CatalogLayer-KWVABPGB.js").then(((e3) => e3.default)));
        break;
      case "FeatureLayer":
        r.push(import("./FeatureLayer-VQJOKGWX.js").then(((e3) => e3.default)));
        break;
      case "OrientedImageryLayer":
        r.push(import("./OrientedImageryLayer-FA4T7GG4.js").then(((e3) => e3.default)));
    }
  }));
...
//# sourceMappingURL=featureLayerUtils-HSFDXUZM.js.map
