import {
  ...
  t as t5,
  u as u2
} from "./chunk-7BTCPKME.js";
import "./chunk-XMPN3RMF.js";
import {
  T as T2
} from "./chunk-6P7VAUP5.js";
import {
  c as c4,
  f as f3,
  o as o2
} from "./chunk-5ADCRXQF.js";
import {
  N as N2,
  i2 as i3
...
import "./chunk-QHFT4N56.js";
import "./chunk-L7T7UOLA.js";
import {
  C,
  G,
  H,
...
var W2 = class extends p(t(b(j2(o2(e(X(i3(c(l3(f2(S(a3.ClonableMixin(h2))))))))))))) {
  constructor(...e4) {
    super(...e4), this._primaryRasters = [], this.legendEnabled = true, this.isReference = null, this.listMode = "show", this.sourceJSON = null, this.version = null, this.type = "imagery-tile", this.operationalLayerType = "ArcGISTiledImageServiceLayer", this.popupEnabled = true, this.popupTemplate = null, this.fields = null, this.source = void 0, this._debouncedSaveOperations = k((async (e5, t7, r7) => {
      const { save: s3, saveAs: i6 } = await import("./imageryUtils-R5FSHQR2.js");
      switch (e5) {
        case A.SAVE:
          return s3(this, t7);
        case A.SAVE_AS:
...
//# sourceMappingURL=ImageryTileLayer-QIH5C7EQ.js.map
