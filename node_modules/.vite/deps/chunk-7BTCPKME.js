...
import {
  T as T2
} from "./chunk-GVVXVQJI.js";
import {
  p,
  r as r3
} from "./chunk-QHFT4N56.js";
import {
  A,
  Q,
  V,
...
var m5 = class extends $ {
  ...
  async _updateClipGeometry() {
    ...
    if (e2 && "inside" === t2.clippingType) {
      const { extent: t3 } = this.rasterInfo, r6 = await import("./densifyOperator-SUBPAGNZ.js"), s3 = await import("./differenceOperator-VKSD3ZLK.js");
    ...
    async _getSampleLocations(e2) {
      ...
      if ("polyline" === r6) {
        ...
        if (e2.sampleCount || e2.sampleDistance) {
          const i7 = await import("./densifyOperator-SUBPAGNZ.js"), s4 = (await import("./lengthOperator-XP2NTZKE.js")).execute(t2, { unit: "meters" }), n3 = Math.min(e2.sampleCount || 100, Q3);
...
//# sourceMappingURL=chunk-7BTCPKME.js.map
