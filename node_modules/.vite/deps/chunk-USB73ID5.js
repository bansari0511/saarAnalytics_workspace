import {
  T
} from "./chunk-EO44SAIJ.js";
import {
  s as s7,
  v as v2
} from "./chunk-XUH7ET3S.js";
import {
  t as t2
} from "./chunk-I552Y7A3.js";
import {
  w2 as w
} from "./chunk-AX65SRWD.js";
import {
  x
} from "./chunk-URLGLIFP.js";
import {
  s as s6
} from "./chunk-X6C26JJQ.js";
import {
  Xe
} from "./chunk-OJJWRUNG.js";
import {
  c as c6
} from "./chunk-7PK7NSON.js";
import {
  p as p3
} from "./chunk-G2PEGJ7A.js";
import {
  d as d5
} from "./chunk-Q6RIIWKW.js";
import {
  c as c5
} from "./chunk-ZLQRJCGG.js";
import {
  A as A2,
  D,
  E,
...
var M2 = class extends O {
  ...
  loadDependencies() {
    return c3({ icon: () => import("./calcite-icon-RQB3CSRL.js") });
  }
  get capabilities() {
...
var T3 = class extends O {
  constructor(e14, t6) {
    super(e14, t6), this._refreshTimer = null, this._refreshIntervalInfo = null, this._featureElementInfo = null, this._chartRootMap = /* @__PURE__ */ new WeakMap(), this.viewModel = new v5(), this.messages = null, this._disposeChart = (e15) => {
      ...
      const { createRoot: r7 } = await import("./chartUtilsAm5-IKN4XFC2.js"), a7 = await r7(e15);
  ...
  async _getSeriesColors(e14) {
    const { colorAm5: t6 } = await import("./chartCommon-N3XQRXNF.js"), i11 = /* @__PURE__ */ new Map();
    return e14.forEach(((e15) => {
      e15.color && i11.set(e15, t6(e15.color.toCss(true)));
    })), i11;
  }
  async _getRendererColors() {
    const { colorAm5: e14 } = await import("./chartCommon-N3XQRXNF.js"), t6 = /* @__PURE__ */ new Map(), i11 = this._getRenderer(), r7 = "default";
    if (!i11) return t6;
  ...
  async _renderChart(e14) {
    const { root: t6, mediaInfo: i11 } = e14, { value: r7, type: a7 } = i11, { ResponsiveThemeAm5: o5, DarkThemeAm5: s12, AnimatedThemeAm5: n13, ColorSetAm5: l5, ThemeAm5: d10, esriChartColorSet: m6 } = await import("./chartCommon-N3XQRXNF.js"), c14 = d10.new(t6);
  ...
  async _customizeChartTooltip(e14, t6 = "horizontal") {
    const { colorAm5: i11 } = await import("./chartCommon-N3XQRXNF.js");
  ...
  async _createPieChart(e14, t6) {
    const { TooltipAm5: i11 } = await import("./chartCommon-N3XQRXNF.js"), { PieChartAm5: r7, PieSeriesAm5: a7 } = await import("./pieChart-HY7BTH3M.js"), { mediaInfo: o5, root: s12 } = e14, { title: n13 } = o5, l5 = 5, d10 = o5?.altText || o5?.title || "", m6 = s12.container.children.push(r7.new(s12, { ariaLabel: d10, focusable: true, paddingBottom: l5, paddingTop: l5, paddingLeft: l5, paddingRight: l5 })), c14 = "{category}: {valuePercentTotal.formatNumber('0.00')}%\n ({value})", h8 = i11.new(s12, { labelText: c14 }), p10 = m6.series.push(a7.new(s12, { name: n13, valueField: A4, categoryField: w5, tooltip: h8 }));
  ...
  async _createColumnChart(e14, t6, i11) {
    const { TooltipAm5: r7, ScrollbarAm5: a7 } = await import("./chartCommon-N3XQRXNF.js"), { CategoryAxisAm5: o5, AxisRendererXAm5: s12, ValueAxisAm5: n13, AxisRendererYAm5: l5, ColumnSeriesAm5: d10 } = await import("./xyChart-QSGTXTB4.js"), { mediaInfo: m6, root: c14 } = t6, { value: p10, title: u10 } = m6;
  ...
  async _createLineChart(e14, t6, i11) {
    const { TooltipAm5: r7, ScrollbarAm5: a7 } = await import("./chartCommon-N3XQRXNF.js"), { CategoryAxisAm5: o5, AxisRendererXAm5: s12, ValueAxisAm5: n13, AxisRendererYAm5: l5, LineSeriesAm5: d10 } = await import("./xyChart-QSGTXTB4.js"), { root: m6, mediaInfo: c14 } = t6, { value: p10, title: u10 } = c14;
    e14.setAll({ wheelX: "panX", wheelY: "zoomX" });
  ...
  async _createXYChart(e14, t6) {
    const { XYChartAm5: i11, XYCursorAm5: r7 } = await import("./xyChart-QSGTXTB4.js"), { root: a7, mediaInfo: o5 } = e14, { type: s12 } = o5, n13 = o5?.altText || o5?.title || "", l5 = a7.container.children.push(i11.new(a7, { ariaLabel: n13, focusable: true, panX: true, panY: true }));
...
async function l4() {
  const [e14, r7] = await Promise.all([import("./arcade-M4GAWCVO.js"), import("./arcade-SB47LT3E.js")]);
...
var g4 = class extends O {
  ...
  loadDependencies() {
    return c3({ loader: () => import("./calcite-loader-TWEQLYHA.js") });
  }
  destroy() {
  ...
  async _queryFeatureCount() {
    ...
    if ("subtype-group" === t6?.type && !l5) {
      if (this._set("featureCount", 0), this._destroyRelatedFeatureViewModels(), this.featurePage = 1, this.relatedFeatures.destroyAll(), s12 && null != u10) {
        const { default: e15 } = await import("./uniqueValues-KX5XNR52.js"), { uniqueValueInfos: l6 } = await e15({ layer: t6, sqlWhere: `${s12} = '${u10}'`, field: t6.subtypeField, signal: r7?.signal }), a8 = l6.map((({ count: e16, value: r8 }) => {
...
var M4 = b7 = class extends O {
  ...
  loadDependencies() {
    return c3({ chip: () => import("./calcite-chip-SF5K33IP.js"), icon: () => import("./calcite-icon-RQB3CSRL.js"), list: () => import("./calcite-list-H4GFEKDI.js"), "list-item": () => import("./calcite-list-item-BPILWX5G.js"), loader: () => import("./calcite-loader-TWEQLYHA.js"), notice: () => import("./calcite-notice-CX7VKVF2.js") });
  }
  destroy() {
  ...
  async _selectRecord(e14) {
    ...
    const { default: i11 } = await import("./Feature-PE5F5A57.js");
...
var v8 = class extends O {
  ...
  loadDependencies() {
    return c3({ icon: () => import("./calcite-icon-RQB3CSRL.js"), list: () => import("./calcite-list-H4GFEKDI.js"), "list-item": () => import("./calcite-list-item-BPILWX5G.js"), loader: () => import("./calcite-loader-TWEQLYHA.js"), notice: () => import("./calcite-notice-CX7VKVF2.js") });
  }
  destroy() {
...
var F8 = class extends n12(O) {
  ...
  loadDependencies() {
    return c3({ notice: () => import("./calcite-notice-CX7VKVF2.js"), loader: () => import("./calcite-loader-TWEQLYHA.js") });
  }
  destroy() {
    ...
    if (Array.isArray(n13)) n13.forEach(((n14, r7) => {
      ...
      if ("utility-network-associations" === n14.type) {
        const e15 = async (e16) => {
          ...
          const { default: l5 } = await import("./FeatureUtilityNetworkAssociationList-GJRUTQNS.js"), d10 = new l5({ viewModel: n16, parentFeatureViewModel: i11, listType: o6, title: r8, featureVisibleElements: t6, description: i11.title, flowItems: s12 });
          s12.push(d10);
...
//# sourceMappingURL=chunk-USB73ID5.js.map
