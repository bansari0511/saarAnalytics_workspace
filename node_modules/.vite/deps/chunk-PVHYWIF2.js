...
async function i() {
  if (!o()) {
    const [n2, o2] = await Promise.all([import("./OperatorGeodeticArea-J4UL7X4Q.js"), import("./ProjectionTransformation-KQYFEJZJ.js").then(((e2) => e2.aG)).then((({ injectPe: e2 }) => e2)), _()]);
...
async function m() {
  if (!c()) {
    const [e2] = await Promise.all([import("./apiConverter-PD46IVTE.js"), i()]);
...
//# sourceMappingURL=chunk-PVHYWIF2.js.map
