import {
  e
} from "./chunk-IPVVOLFL.js";
import {
  O
} from "./chunk-VWAUFSIQ.js";
import {
  l as l6
...
var L = I = (_a = class extends l.JSONSupportMixin(p2) {
  ...
  async queryElevation(r5, e2) {
    ...
    const { ElevationQuery: o4 } = await import("./ElevationQuery-FFQYUMC7.js");
    s2(e2);
  ...
  async _loadLayersFromJSON(r5, e2, o4) {
    const t4 = e2?.origin || "web-scene", s4 = e2?.portal || null, a6 = e2?.url || null, { populateOperationalLayers: i5 } = await import("./layersCreator-CI2K7NB6.js");
    s2(o4);
    const n5 = [];
...
//# sourceMappingURL=chunk-AMUU4XRR.js.map
