import "./chunk-L26YCXHA.js";
import "./chunk-NC6ZZGDK.js";
...
async function h2(e4) {
  ...
  let l;
  const [{ projectBuffer: u3 }, { initializeProjection: m2 }] = await Promise.all([import("./projectBuffer-MAJFMFBD.js"), import("./projectionUtils-NAFAXAQK.js")]);
  await m2(f2, c3);
  const y2 = [0, 0, 0];
  ...
  if ("georeferenced" === a2.type && null == a2.origin) {
    ...
    const e5 = "georeferenced" === a2.type ? i.fromJSON(a2) : i2.fromJSON(a2), { projectMeshVertexPositions: r4 } = await import("./projectMeshVertexPositions-XZPXKMOF.js"), s2 = r4({ vertexAttributes: { position: i5 }, transform: n8 ? { localMatrix: n8 } : void 0, vertexSpace: e5, spatialReference: f2 }, c3);
...
//# sourceMappingURL=SceneLayerWorker-2GJTC7S6.js.map
