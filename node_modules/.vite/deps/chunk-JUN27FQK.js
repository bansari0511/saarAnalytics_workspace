...
async function o2(o3) {
  const a2 = "portalItem" in o3 ? o3 : { portalItem: o3 }, { fromItem: e } = await import("./portalLayers-P6EODCNA.js");
  try {
    return await e(a2);
  } catch (p2) {
...
var h = class extends o.EventedMixin(n.IdentifiableMixin(p)) {
  ...
  static async fromArcGISServerUrl(e) {
    ...
    return (await import("./arcgisLayers-OIMIUIDS.js")).fromUrl(t);
  }
...
//# sourceMappingURL=chunk-JUN27FQK.js.map
