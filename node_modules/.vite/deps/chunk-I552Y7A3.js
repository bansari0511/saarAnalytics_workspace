...
async function t(l2, o, r3) {
  ...
  return (await Promise.all(u2.map((async (e, r4) => {
    const n2 = "opacity" === l2.type ? await a(e, l2, o) : (await import("./visualVariableUtils-HV6AWDT7.js")).getColor(l2, e), u3 = t2 ? s2[r4] : p?.[r4] ?? "";
    return null == n2 ? null : { value: e, color: n2, label: u3 };
  })))).filter(L).reverse();
}
async function a(e, o, n2) {
  const t2 = new l(n2 ?? r2), a2 = (await import("./visualVariableUtils-HV6AWDT7.js")).getOpacity(o, e);
...
//# sourceMappingURL=chunk-I552Y7A3.js.map
