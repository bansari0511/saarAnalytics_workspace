import {
  e
} from "./chunk-75TRDMAM.js";
import {
  O
} from "./chunk-DOJJX33X.js";
import {
  l as l6
...
var L = I = (_a = class extends l.JSONSupportMixin(p2) {
  ...
  async queryElevation(r5, e2) {
    ...
    const { ElevationQuery: o4 } = await import("./ElevationQuery-463MFXUX.js");
    s2(e2);
  ...
  async _loadLayersFromJSON(r5, e2, o4) {
    const t4 = e2?.origin || "web-scene", s4 = e2?.portal || null, a6 = e2?.url || null, { populateOperationalLayers: i5 } = await import("./layersCreator-E2QE256I.js");
    s2(o4);
    const n5 = [];
...
//# sourceMappingURL=chunk-W6JB3ZDF.js.map
