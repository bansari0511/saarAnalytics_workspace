...
import {
  ...
  t,
  z
} from "./chunk-4WCYCUZM.js";
import {
  c as c6,
  l as l6,
  l2 as l7,
  r as r3
} from "./chunk-MNN3WDKU.js";
import {
  g as g2,
  g2 as g3
} from "./chunk-Z5R4YOHZ.js";
import {
  n as n5,
  p as p4,
  s as s5
} from "./chunk-C3UR7COL.js";
import "./chunk-W5CL56LA.js";
import {
  p as p3
} from "./chunk-K4LQ6UIZ.js";
import "./chunk-A33LP2U6.js";
...
import {
  r as r6
} from "./chunk-OKREULKW.js";
import {
  r as r7
} from "./chunk-OOV7EHUP.js";
...
import {
  ...
  d as d5,
  h as h4
} from "./chunk-XEMPF3AE.js";
import {
  c as c3
} from "./chunk-GPGUIBLO.js";
import {
  f as f2,
  j as j3,
  l as l3,
...
var x3 = class extends o.EventedMixin(b) {
  ...
  async _createSelfSnappingEngine(e6) {
    const [{ SelfSnappingEngine: t3 }, n10] = await Promise.all([import("./SelfSnappingEngine-CB5XPB4H.js"), g4()]);
  ...
  async _createGridSnappingEngine(e6) {
    ...
    const { GridSnappingEngine: n10 } = await import("./GridSnappingEngine-5WVXGEAV.js");
    return s2(e6), { type: "grid", engine: new n10({ view: t3, options: this.options }) };
  }
  async _createFeatureSnappingEngine(e6) {
    const { FeatureSnappingEngine: t3 } = await import("./FeatureSnappingEngine-5KSLLPLN.js");
    s2(e6);
...
async function o4() {
  const e6 = await import("./geometryEngine-7H3QDWLX.js");
  return s6(e6);
}
function n6(t3) {
...
var re = class extends o.EventedAccessor {
  ...
  initialize() {
    this.addHandles([a2((() => this.view?.map?.layers), "change", ((e6) => {
      ...
      this._defaultSnappingManager = u(this._defaultSnappingManager), e6 && (this.snappingManager || (this._defaultSnappingManager = new x3({ view: e6, options: this.snappingOptions })), "2d" === e6.type ? import("./editingTools-SOCGM6TZ.js") : "3d" === e6.type && (import("./editingTools-ULJ7QU6W.js"), import("./GraphicsLayerView3D-CYVGKX63.js")));
  ...
  async _makeDrawGraphicTool2D(e6) {
    const [t3, o6, i4] = await Promise.all([this._requireModule(import("./editingTools-SOCGM6TZ.js")), u5(), c8()]);
  ...
  async _makeDrawGraphicTool3D(e6) {
    const [t3, o6, i4] = await Promise.all([this._requireModule(import("./editingTools-ULJ7QU6W.js")), u5(), c8()]);
  ...
  async _setupMove3DOperation(e6, t3, o6, i4, s8 = false) {
    const [r12, n10] = await Promise.all([this._requireModule(import("./editingTools-ULJ7QU6W.js")), c8()]);
  ...
  async _setupPointTransform3DOperation(e6, t3, o6) {
    const i4 = "transform", { enableRotation: s8, enableScaling: r12, enableZ: n10 } = t3, p8 = await this._requireModule(import("./editingTools-ULJ7QU6W.js"));
    if (ge(p8)) return p8;
  ...
  async _setupPolyTransform3DOperation(e6, t3, o6, i4 = false) {
    const s8 = "transform", { enableRotation: r12, enableScaling: n10, enableZ: p8, preserveAspectRatio: l9 } = t3, [h8, c9] = await Promise.all([this._requireModule(import("./editingTools-ULJ7QU6W.js")), c8()]);
    if (ge(h8)) return h8;
  ...
  async _setupReshape3DOperation(e6, t3, o6, i4 = false) {
    const s8 = "reshape", [r12, n10, p8] = await Promise.all([this._requireModule(import("./editingTools-ULJ7QU6W.js")), u5(), c8()]);
    if (ge(r12)) return r12;
  ...
  async _getGraphicMover(e6, t3, o6) {
    const { enableMoveAllGraphics: i4, highlightOptions: a8 } = t3, s8 = await this._requireModule(import("./GraphicMover-E7SZLJQF.js"));
  ...
  async _getBox(e6, t3, o6) {
    const { enableRotation: i4, enableScaling: a8, highlightOptions: s8, preserveAspectRatio: r12 } = t3, [n10, p8] = await Promise.all([this._requireModule(import("./Box-WLEX3HB4.js")), c8()]);
  ...
  async _getReshape(e6, t3, o6) {
    const { highlightOptions: i4, reshapeOptions: a8 } = t3, s8 = "split" === a8?.edgeOperation, r12 = "move" === a8?.shapeOperation, [n10, p8, l9] = await Promise.all([this._requireModule(import("./Reshape-KYQWQUC3.js")), u5(), c8()]);
...
//# sourceMappingURL=RouteLayerInteraction-53SOZZUB.js.map
