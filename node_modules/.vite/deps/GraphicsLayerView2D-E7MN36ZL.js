...
var d2 = class extends S(u2) {
  ...
  async hitTest(i) {
    return this.graphicsView ? this.graphicsView.hitTest(i).map(((r2) => ({ type: "graphic", graphic: r2, mapPoint: i, layer: this.layer }))) : null;
  }
  queryGraphics() {
  ...
  highlight(i, a2) {
    let h;
    "number" == typeof i ? h = [i] : i instanceof d ? h = [i.uid] : Array.isArray(i) && i.length > 0 ? h = "number" == typeof i[0] ? i : i.map(((i2) => i2 && i2.uid)) : V.isCollection(i) && i.length > 0 && (h = i.map(((i2) => i2 && i2.uid)).toArray());
    const o = h?.filter(L);
...
//# sourceMappingURL=GraphicsLayerView2D-E7MN36ZL.js.map
