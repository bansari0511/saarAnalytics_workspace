...
async function p(t2, e) {
  ...
  if ("image/gif" === a) {
    const { isAnimatedGIF: t3, parseGif: a2 } = await import("./gif-V6SDGQ5H.js");
    if (t3(r)) return a2(r, e);
  }
  if (n) {
    const { isAnimatedPNG: t3, parseApng: a2 } = await import("./apng-3QBPVWCK.js");
    if (t3(r)) return a2(r, e);
  }
...
//# sourceMappingURL=chunk-I5XBK5ZU.js.map
