    ...
    var D = (function() {
      ...
      return r(t2, [{ key: "setGlobalMarkerSize", value: function() {
        ...
        if ((o2.globals.markers.size[e2] > 0 || r2 || d2) && (h2 = c2.group({ class: r2 || d2 ? "" : "apexcharts-series-markers" })).attr("clip-path", "url(#gridRectMarkerMask".concat(o2.globals.cuid, ")")), Array.isArray(l2.x)) {
          for (var g2 = 0; g2 < l2.x.length; g2++) if (!(l2.x[g2] < 0 || l2.x[g2] > o2.globals.gridWidth || l2.y[g2] < 0 || l2.y[g2] > o2.globals.gridHeight)) {
            var u2 = i2;
    ...
    var O = (function() {
      ...
      return r(t2, [{ key: "dataLabelsCorrection", value: function(t3, e2, i2, a2, s2, r2, o2) {
        ...
        for (var x2 = 0; x2 < a2.x.length; x2++) if (g2 = a2.x[x2] + d2.offsetX, u2 = a2.y[x2] + d2.offsetY + l2, !isNaN(g2)) {
          ...
          if ("bubble" === h2.config.chart.type) v2 = y2(b2 = h2.globals.seriesZ[s2][f2]), u2 = a2.y[x2], u2 = new H(this.ctx).centerTextInBubble(u2, s2, f2).y;
    ...
    var W = (function() {
      ...
      return r(t2, [{ key: "isMultiFormat", value: function() {
        ...
        if (e2.xaxis.categories.length > 0) i2.labels = e2.xaxis.categories;
          ...
          }))), e2.xaxis.convertedCatToNumeric) new X(e2).convertCatToNumericXaxis(e2, this.ctx, i2.seriesX[0]), this._generateExternalLabels(t3);
      ...
      return r(s2, [{ key: "draw", value: function(t3, i3) {
        ...
        for (var r2 = s3.group({ class: "apexcharts-rangebar-series apexcharts-plot-series" }), o2 = 0; o2 < t3.length; o2++) {
          ...
          for (var y2 = s3.group({ class: "apexcharts-datalabels", "data:realIndex": u2 }), w2 = s3.group({ class: "apexcharts-rangebar-goals-markers", style: "pointer-events: none" }), k2 = 0; k2 < a2.globals.dataPoints; k2++) {
            ...
            } else p2 = (L2 = this.drawRangeColumnPaths(e({ indexes: { i: o2, j: k2, realIndex: u2 }, zeroH: l2, barWidth: b2, xDivision: n2 }, I2))).barHeight;
