...
async function i() {
  if (!u()) {
    const [n2, e] = await Promise.all([import("./ProjectionTransformation-KQYFEJZJ.js").then(((n3) => n3.aH)), import("./ProjectionTransformation-KQYFEJZJ.js").then(((n3) => n3.aG)).then((({ injectPe: n3 }) => n3)), _()]);
...
async function d() {
  if (!T()) {
    const [t, o2, a2, T2] = await Promise.all([import("./apiConverter-PD46IVTE.js"), import("./ProjectionTransformation-KQYFEJZJ.js").then(((e) => e.aI)).then((({ CompositeGeographicTransformationEditor: e }) => e)), import("./ProjectionTransformation-KQYFEJZJ.js").then(((e) => e.aJ)).then((({ create: e, createFromWKT: t2 }) => ({ create: e, createFromWKT: t2 }))), import("./ProjectionTransformation-KQYFEJZJ.js").then(((e) => e.aK)).then((({ create: e, createEx: t2, createFromAoi: r2 }) => ({ create: e, createEx: t2, createFromAoi: r2 }))), i()]);
...
//# sourceMappingURL=chunk-AXMFPIMZ.js.map
