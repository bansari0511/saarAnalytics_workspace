import {
  ...
  t as t5,
  u as u2
} from "./chunk-L6U3HWP2.js";
import "./chunk-L34UDD52.js";
import {
  T as T2
} from "./chunk-O6NJWYDH.js";
import {
  c as c4,
  f as f3,
  o as o2
} from "./chunk-ZYL3YIDZ.js";
import {
  N as N2,
  i2 as i3
} from "./chunk-43RCGWMO.js";
import {
  $,
  N as N3,
  b as b2,
...
import {
  m as m5,
  n as n2
} from "./chunk-XHS4OCS6.js";
import {
  T,
  w
} from "./chunk-WAFSGNZ4.js";
import "./chunk-CE4PHRRJ.js";
import "./chunk-OQXO6SXY.js";
import {
  C,
  G,
  H,
...
var W2 = class extends p(t(b(j2(o2(e(X(i3(c(l3(f2(S(a3.ClonableMixin(h2))))))))))))) {
  constructor(...e4) {
    super(...e4), this._primaryRasters = [], this.legendEnabled = true, this.isReference = null, this.listMode = "show", this.sourceJSON = null, this.version = null, this.type = "imagery-tile", this.operationalLayerType = "ArcGISTiledImageServiceLayer", this.popupEnabled = true, this.popupTemplate = null, this.fields = null, this.source = void 0, this._debouncedSaveOperations = k((async (e5, t7, r7) => {
      const { save: s3, saveAs: i6 } = await import("./imageryUtils-KO3GO7IK.js");
      switch (e5) {
        case A.SAVE:
          return s3(this, t7);
        case A.SAVE_AS:
...
//# sourceMappingURL=ImageryTileLayer-7QNY4NM3.js.map
