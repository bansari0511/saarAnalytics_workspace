...
function r(r2, e2) {
  e2.snowCover && (r2.code.add(n2`float getSnow(vec3 normal, vec3 normalGround) {
return smoothstep(0.5, 0.55, dot(normal, normalGround));
}`), r2.code.add(n2`vec3 applySnowToMRR(vec3 mrr, float snow) {
...
//# sourceMappingURL=chunk-B7IV47DD.js.map
