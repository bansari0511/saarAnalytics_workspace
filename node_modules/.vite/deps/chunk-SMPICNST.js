...
async function v(e) {
  ...
  const s4 = a.spatialReference, l2 = n ? g2.fromJSON(n) : te(s4), m2 = s4 && (P(s4) || O(s4)) ? a : await x(s4, U).then((() => j(a, U))), f3 = await import("./geodesicBufferOperator-MHWQMWXL.js");
  await f3.load();
...
//# sourceMappingURL=chunk-SMPICNST.js.map
