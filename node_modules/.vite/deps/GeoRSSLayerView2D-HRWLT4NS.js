  ...
  attach() {
    this.addAttachHandles([l((() => this.layer?.featureCollections), ((e) => {
      ...
      for (const { popupInfo: i, featureSet: t3, layerDefinition: o } of e) {
        const e2 = g.fromJSON(t3), p = new V(e2.features), n = o.drawingInfo, m2 = i ? q.fromJSON(i) : null, y2 = t(n.renderer), g3 = new O({ requestUpdateCallback: () => this.requestUpdate(), view: this.view, graphics: p, renderer: y2, container: new t2(this.view.featuresTilingScheme) });
        this._graphicsViewMap[e2.geometryType] = g3, this._popupTemplates.set(g3, m2), "polygon" !== e2.geometryType || this.layer.polygonSymbol ? "polyline" !== e2.geometryType || this.layer.lineSymbol ? "point" !== e2.geometryType || this.layer.pointSymbol || (this.layer.pointSymbol = y2.symbol) : this.layer.lineSymbol = y2.symbol : this.layer.polygonSymbol = y2.symbol, this.graphicsViews.push(g3), this.container.addChild(g3.container);
      }
...
y = r([a("esri.views.2d.layers.GeoRSSLayerView2D")], y);
var g2 = y;
export {
  g2 as default
};
//# sourceMappingURL=GeoRSSLayerView2D-HRWLT4NS.js.map
