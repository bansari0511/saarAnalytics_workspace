...
function i() {
  return t ??= (async () => {
    const i3 = await import("./basis_encoder-WJGUZWV7.js"), t2 = await i3.default({ locateFile: (i4) => n(`esri/libs/basisu/${i4}`) });
...
function e() {
  return r ??= (async () => {
    const e2 = await import("./dxt_encoder-VTPQNNSN.js");
...
//# sourceMappingURL=TextureCompressionWorker-SHCY6U5R.js.map
