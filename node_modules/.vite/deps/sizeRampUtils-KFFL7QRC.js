import {
  g
} from "./chunk-6KRWJPGF.js";
import "./chunk-5YBAYRAT.js";
import "./chunk-R62BLGYS.js";
import "./chunk-XEJI3JPO.js";
import "./chunk-4TJU2MPF.js";
import {
  c,
  i,
  l as l2,
...
async function H(e2, t2, o, i3) {
  const n2 = (await import("./visualVariableUtils-HV6AWDT7.js")).getSizeRangeAtScale(e2, o, i3), r2 = n2 && O(n2);
  if (!n2 || !r2) return;
...
async function G2(e2, t2, l3, o, i3) {
  const { getSize: n2 } = await import("./visualVariableUtils-HV6AWDT7.js");
...
//# sourceMappingURL=sizeRampUtils-KFFL7QRC.js.map
