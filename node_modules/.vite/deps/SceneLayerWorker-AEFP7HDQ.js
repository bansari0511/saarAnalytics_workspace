import "./chunk-OFRQNMDN.js";
import "./chunk-Q6C4OXXC.js";
...
function e2() {
  return n5 || (n5 = new Promise(((t) => import("./i3s-TRNBGBP7.js").then(((t2) => t2.i)).then((({ default: e4 }) => {
...
async function h2(e4) {
  ...
  let l;
  const [{ projectBuffer: u3 }, { initializeProjection: m2 }] = await Promise.all([import("./projectBuffer-T5B3G56M.js"), import("./projectionUtils-NAXSBY5P.js")]);
  await m2(f2, c3);
  const y2 = [0, 0, 0];
  ...
  if ("georeferenced" === a2.type && null == a2.origin) {
    ...
    const e5 = "georeferenced" === a2.type ? i.fromJSON(a2) : i2.fromJSON(a2), { projectMeshVertexPositions: r4 } = await import("./projectMeshVertexPositions-ZOWBTJGY.js"), s2 = r4({ vertexAttributes: { position: i5 }, transform: n8 ? { localMatrix: n8 } : void 0, vertexSpace: e5, spatialReference: f2 }, c3);
...
//# sourceMappingURL=SceneLayerWorker-AEFP7HDQ.js.map
