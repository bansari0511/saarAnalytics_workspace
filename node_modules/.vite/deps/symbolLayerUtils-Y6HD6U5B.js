...
async function f(e2, o = null) {
  if (!e2.isPrimitive) {
    ...
    const { fetch: n2 } = await import("./objectResourceUtils-LLJDXKIH.js"), a3 = await n2(o2, { disableTextures: true, spherical: true }), u3 = p(a3.referenceBoundingBox, n());
...
//# sourceMappingURL=symbolLayerUtils-Y6HD6U5B.js.map
