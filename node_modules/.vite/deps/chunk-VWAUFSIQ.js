...
var x = _ = class extends l.JSONSupportMixin(p) {
  ...
  async _loadLayersFromJSON(e, r3, t2) {
    const s4 = this.resourceInfo?.context, a4 = this.portalItem?.portal || s4?.portal || null, o = F[s4?.origin || ""] ?? "web-map", { populateOperationalLayers: i3 } = await import("./layersCreator-CI2K7NB6.js"), n2 = [];
...
//# sourceMappingURL=chunk-VWAUFSIQ.js.map
