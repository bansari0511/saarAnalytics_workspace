...
var Ae = class extends m5(F(R2(l2(b2(j2(t(S(e2(i3(a5.ClonableMixin(h2))))))))))) {
  ...
  async applyEdits(e5, t7) {
    const { applyEdits: r4 } = await import("./editingSupport-YIMKG6B4.js");
    let i7 = t7;
    await this.load();
  ...
  async convertMesh(e5, t7) {
    ...
    const a9 = this.spatialReference, l6 = t7.location ?? new _({ x: 0, y: 0, z: 0, spatialReference: a9 }), p6 = l6.spatialReference.isGeographic ? "local" : "georeferenced", { default: d3 } = await import("./Mesh-LBOOP3JR.js"), y2 = d3.createWithExternalSource(l6, { type: "client", files: i7 }, { vertexSpace: p6, transform: t4(l6.spatialReference), unitConversionDisabled: true }), [u6] = await this.uploadAssets([y2], { ...t7, useAssetOrigin: !t7.location });
    return u6;
  }
...
//# sourceMappingURL=SceneLayer-BKEZOPX5.js.map
