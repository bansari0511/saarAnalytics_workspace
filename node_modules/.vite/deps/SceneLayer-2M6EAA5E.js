...
import {
  R as R2,
  V as V3
} from "./chunk-NR5DDIVZ.js";
import {
  $,
  P,
  w
} from "./chunk-WHNSSW5C.js";
import "./chunk-X5GNK4Z2.js";
import {
  B
} from "./chunk-Q6C4OXXC.js";
...
import {
  c,
  t as t2
} from "./chunk-X54A5S3J.js";
import {
  s as s3
} from "./chunk-3B32E5HH.js";
import {
  i as i4
} from "./chunk-ZBM5QEVD.js";
import {
  i as i3
...
import {
  l as l5
} from "./chunk-KD7NWUMU.js";
import {
  v
} from "./chunk-YAWDKLAW.js";
...
async function t6(e5) {
  const { BlobReader: t7, ZipReader: r4, BlobWriter: n4 } = await import("./zipjs-wrapper-BYS5KGZH.js"), a9 = [], i7 = new r4(new t7(e5));
...
var Ae = class extends m5(F(R2(l2(b2(j2(t(S(e2(i3(a5.ClonableMixin(h2))))))))))) {
  ...
  async applyEdits(e5, t7) {
    const { applyEdits: r4 } = await import("./editingSupport-GDTVMEUG.js");
    let i7 = t7;
    await this.load();
  ...
  async convertMesh(e5, t7) {
    ...
    const a9 = this.spatialReference, l6 = t7.location ?? new _({ x: 0, y: 0, z: 0, spatialReference: a9 }), p6 = l6.spatialReference.isGeographic ? "local" : "georeferenced", { default: d3 } = await import("./Mesh-QMDOOS46.js"), y2 = d3.createWithExternalSource(l6, { type: "client", files: i7 }, { vertexSpace: p6, transform: t4(l6.spatialReference), unitConversionDisabled: true }), [u6] = await this.uploadAssets([y2], { ...t7, useAssetOrigin: !t7.location });
    return u6;
  }
...
//# sourceMappingURL=SceneLayer-2M6EAA5E.js.map
