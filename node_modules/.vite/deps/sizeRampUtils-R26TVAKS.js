import {
  g
} from "./chunk-P3RMR5V4.js";
import "./chunk-R55Z74SX.js";
import "./chunk-R62BLGYS.js";
import "./chunk-EXTNFABJ.js";
import "./chunk-5L5X7GYW.js";
import {
  c,
  i,
  l as l2,
...
async function H(e2, t2, o, i3) {
  const n2 = (await import("./visualVariableUtils-UQHXDDQA.js")).getSizeRangeAtScale(e2, o, i3), r2 = n2 && O(n2);
  if (!n2 || !r2) return;
...
async function G2(e2, t2, l3, o, i3) {
  const { getSize: n2 } = await import("./visualVariableUtils-UQHXDDQA.js");
...
//# sourceMappingURL=sizeRampUtils-R26TVAKS.js.map
