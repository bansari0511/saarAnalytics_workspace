  ...
  initialize() {
    this.addHandles([l((() => [this.interactive, this.suspended]), (async () => {
      if (this.interactive && !this._interaction) {
        const { MediaLayerInteraction: e3 } = await import("./MediaLayerInteraction-3PDDEOJS.js");
...
//# sourceMappingURL=MediaLayerView2D-BTLWBAVE.js.map
