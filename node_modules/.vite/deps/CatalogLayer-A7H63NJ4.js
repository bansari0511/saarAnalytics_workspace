...
import {
  G
} from "./chunk-3MNBG7X2.js";
import "./chunk-SOLKTR3L.js";
import "./chunk-PJAT25TZ.js";
import "./chunk-RMYJTC6J.js";
...
var W = class extends a4(k2(F(p(p2(c2(t(f(l2(b(j(S(e4(i(h)))))))))))))) {
  ...
  async queryAttributeBins(e5, t3) {
    ...
    const o = await import("./AttributeBinsQuery-RWKRG6VQ.js"), s4 = await r4.queryAttributeBins(o.default.from(e5), t3);
  ...
  async _createLayer(e5) {
    ...
    const { default: s4 } = await import("./UnsupportedLayer-YFBQZ7NH.js");
    return new s4();
  }
...
//# sourceMappingURL=CatalogLayer-A7H63NJ4.js.map
