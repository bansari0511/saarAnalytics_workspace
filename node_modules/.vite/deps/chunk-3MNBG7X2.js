...
var G2 = class extends p {
  ...
  async uploadAssets(e2, t3) {
    const { uploadAssets: s5 } = await import("./uploadAssets-XK5HA7AB.js");
  ...
  async _uploadMeshesAndGetAssetMapEditsJSON(e2) {
    ...
    for (const i5 of t3) {
      ...
      if (t(t4)) r3.push(e3);
        ...
        const t5 = e3.origin, { convertMeshVertexSpace: s6 } = await import("./convertMeshVertexSpace-H6J6PAFL.js"), n = await s6(e3, new i2({ origin: [t5.x, t5.y, t5.z ?? 0] }));
...
//# sourceMappingURL=chunk-3MNBG7X2.js.map
