...
async function m() {
  if (!p()) {
    const [t, e, r2, p2] = await Promise.all([import("./Envelope2D-VGGUZPVD.js"), import("./ProjectionTransformation-KQYFEJZJ.js").then(((n) => n.aK)).then((({ queryTransformationList: n }) => n)), import("./ProjectionTransformation-KQYFEJZJ.js").then(((n) => n.aG)).then((({ injectPe: n }) => n)), import("./apiConverter-PD46IVTE.js"), _()]);
...
//# sourceMappingURL=geographicTransformationUtils-SW5TZ3MX.js.map
