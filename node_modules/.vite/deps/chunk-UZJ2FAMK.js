...
async function d() {
  if (!T()) {
    const [t, o2, a2, T2] = await Promise.all([import("./apiConverter-34L6BCGB.js"), import("./ProjectionTransformation-KQYFEJZJ.js").then(((e) => e.aI)).then((({ CompositeGeographicTransformationEditor: e }) => e)), import("./ProjectionTransformation-KQYFEJZJ.js").then(((e) => e.aJ)).then((({ create: e, createFromWKT: t2 }) => ({ create: e, createFromWKT: t2 }))), import("./ProjectionTransformation-KQYFEJZJ.js").then(((e) => e.aK)).then((({ create: e, createEx: t2, createFromAoi: r2 }) => ({ create: e, createEx: t2, createFromAoi: r2 }))), i()]);
...
//# sourceMappingURL=chunk-UZJ2FAMK.js.map
