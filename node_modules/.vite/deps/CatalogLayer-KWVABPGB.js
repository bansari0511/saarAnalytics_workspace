...
var W = class extends a4(k2(F(p(p2(c2(t(f(l2(b(j(S(e4(i(h)))))))))))))) {
  ...
  async queryAttributeBins(e5, t3) {
    ...
    const o = await import("./AttributeBinsQuery-XCOC5ABF.js"), s4 = await r4.queryAttributeBins(o.default.from(e5), t3);
  ...
  async _createLayer(e5) {
    ...
    const { default: s4 } = await import("./UnsupportedLayer-IY2BN5UN.js");
    return new s4();
  }
...
//# sourceMappingURL=CatalogLayer-KWVABPGB.js.map
