import {
  n
} from "./chunk-PJAT25TZ.js";
import {
  i,
  s as s3
} from "./chunk-RMYJTC6J.js";
import {
  a as a2
...
import {
  O
} from "./chunk-53C4DAKL.js";
import {
  R as R2
} from "./chunk-NSIIITDR.js";
import {
  R
} from "./chunk-3Y2NDRJ3.js";
import {
  f
} from "./chunk-2CRE6SXL.js";
import {
  z
...
var S = class extends b {
  ...
  async featureSetFromJSON(e, t, r2) {
    ...
    const { meshFeatureSetFromJSON: s4 } = await h(import("./meshFeatureSet-DWJ4ZTEZ.js"), r2);
  ...
  async executeRelationshipQuery(e, t) {
    const [{ default: r2 }, { executeRelationshipQuery: s4 }] = await h(Promise.all([import("./RelationshipQuery-3QU6F6RX.js"), import("./executeRelationshipQuery-3FP3LUN3.js")]), t);
  ...
  async executeRelationshipQueryForCount(e, t) {
    const [{ default: r2 }, { executeRelationshipQueryForCount: s4 }] = await h(Promise.all([import("./RelationshipQuery-3QU6F6RX.js"), import("./executeRelationshipQuery-3FP3LUN3.js")]), t);
    return e = r2.from(e), (this.gdbVersion || this.dynamicDataSource) && ((e = e.clone()).gdbVersion = e.gdbVersion || this.gdbVersion, e.dynamicDataSource = e.dynamicDataSource || this.dynamicDataSource), s4(this.url, e, t);
  }
  async executeAttachmentQuery(e, t) {
    const { executeAttachmentQuery: r2, fetchAttachments: s4, processAttachmentQueryResult: i2 } = await h(import("./queryAttachments-KA67WGGU.js"), t), u = f(this.url);
    return i2(u, await (this.queryAttachmentsSupported ? r2(u, e, t) : s4(u, e, t)));
  }
  async executeAttributeBinsQuery(e, t) {
    const { executeAttributeBinsQuery: r2 } = await h(import("./executeAttributeBinsQuery-PWFB76QU.js"), t);
    return r2(this.parsedUrl, e, t);
  }
  async executeTopFeaturesQuery(e, t) {
    const { executeTopFeaturesQuery: r2 } = await h(import("./executeTopFeaturesQuery-GVWOGU5X.js"), t);
    return r2(this.parsedUrl, e, this.sourceSpatialReference, t);
  }
  async executeForTopIds(e, t) {
    const { executeForTopIds: r2 } = await h(import("./executeForTopIds-ADDFUBCV.js"), t);
    return r2(this.parsedUrl, e, t);
  }
  async executeForTopExtents(e, t) {
    const { executeForTopExtents: r2 } = await h(import("./executeForTopExtents-WZCNNXSD.js"), t);
    return r2(this.parsedUrl, e, t);
  }
  async executeForTopCount(e, t) {
    const { executeForTopCount: r2 } = await h(import("./executeForTopCount-VD2K76CZ.js"), t);
    return r2(this.parsedUrl, e, t);
  }
  _normalizeQuery(e) {
    let t = R2.from(e);
...
//# sourceMappingURL=chunk-SOLKTR3L.js.map
