import {
  n
} from "./chunk-2JMKQEOG.js";
import {
  i,
  s as s3
} from "./chunk-ZOY6YWKS.js";
import {
  a as a2
...
var S = class extends b {
  ...
  async featureSetFromJSON(e, t, r2) {
    ...
    const { meshFeatureSetFromJSON: s4 } = await h(import("./meshFeatureSet-XZDEY2VM.js"), r2);
  ...
  async executeRelationshipQuery(e, t) {
    const [{ default: r2 }, { executeRelationshipQuery: s4 }] = await h(Promise.all([import("./RelationshipQuery-UZDK3ZO4.js"), import("./executeRelationshipQuery-IWYMFXXD.js")]), t);
  ...
  async executeRelationshipQueryForCount(e, t) {
    const [{ default: r2 }, { executeRelationshipQueryForCount: s4 }] = await h(Promise.all([import("./RelationshipQuery-UZDK3ZO4.js"), import("./executeRelationshipQuery-IWYMFXXD.js")]), t);
    return e = r2.from(e), (this.gdbVersion || this.dynamicDataSource) && ((e = e.clone()).gdbVersion = e.gdbVersion || this.gdbVersion, e.dynamicDataSource = e.dynamicDataSource || this.dynamicDataSource), s4(this.url, e, t);
  }
  async executeAttachmentQuery(e, t) {
    const { executeAttachmentQuery: r2, fetchAttachments: s4, processAttachmentQueryResult: i2 } = await h(import("./queryAttachments-RJBDUQZX.js"), t), u = f(this.url);
    return i2(u, await (this.queryAttachmentsSupported ? r2(u, e, t) : s4(u, e, t)));
  }
  async executeAttributeBinsQuery(e, t) {
    const { executeAttributeBinsQuery: r2 } = await h(import("./executeAttributeBinsQuery-IZ2LGU4A.js"), t);
    return r2(this.parsedUrl, e, t);
  }
  async executeTopFeaturesQuery(e, t) {
    const { executeTopFeaturesQuery: r2 } = await h(import("./executeTopFeaturesQuery-LWID4DXK.js"), t);
    return r2(this.parsedUrl, e, this.sourceSpatialReference, t);
  }
  async executeForTopIds(e, t) {
    const { executeForTopIds: r2 } = await h(import("./executeForTopIds-3MXRDAME.js"), t);
    return r2(this.parsedUrl, e, t);
  }
  async executeForTopExtents(e, t) {
    const { executeForTopExtents: r2 } = await h(import("./executeForTopExtents-ZZ3XEQFQ.js"), t);
    return r2(this.parsedUrl, e, t);
  }
  async executeForTopCount(e, t) {
    const { executeForTopCount: r2 } = await h(import("./executeForTopCount-GM6NDSIU.js"), t);
    return r2(this.parsedUrl, e, t);
  }
  _normalizeQuery(e) {
    let t = R2.from(e);
...
//# sourceMappingURL=chunk-M4N5VBTX.js.map
