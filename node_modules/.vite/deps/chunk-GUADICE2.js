...
var c = class extends b {
  ...
  async update(t, r2) {
    const { addOrUpdateResources: e2 } = await import("./resourceUtils-5XINELFC.js");
...
var k = v = class extends l2.JSONSupportMixin(p) {
  ...
  async fetchResources(e2 = {}, t) {
    const { fetchResources: i2 } = await import("./resourceUtils-5XINELFC.js");
    return i2(this, e2, t);
  }
  async addResource(e2, t, i2) {
    const { addOrUpdateResources: r2 } = await import("./resourceUtils-5XINELFC.js");
  ...
  async removeResource(e2, t) {
    const { removeResource: r2 } = await import("./resourceUtils-5XINELFC.js");
  ...
  async removeAllResources(e2) {
    const { removeAllResources: t } = await import("./resourceUtils-5XINELFC.js");
    return t(this, e2);
  }
  resourceFromPath(e2) {
...
//# sourceMappingURL=chunk-GUADICE2.js.map
