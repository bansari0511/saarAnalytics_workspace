...
var P = class extends b {
  ...
  _loadSourceModule(e2) {
    ...
    switch (e2) {
      case "featureService":
        return t.addPromise(import("./FeatureServiceSnappingSource-ME7CCCAI.js"));
      case "featureCollection":
        return t.addPromise(import("./FeatureCollectionSnappingSource-7SF6RMDX.js"));
      case "graphics":
      case "notes":
        return t.addPromise(import("./GraphicsSnappingSource-AMQCLBR6.js"));
      case "scene":
        return t.addPromise(import("./SceneLayerSnappingSource-CZAWFFLK.js"));
    }
  }
  get test() {
  }
...
//# sourceMappingURL=FeatureSnappingEngine-5KSLLPLN.js.map
