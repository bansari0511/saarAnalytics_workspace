import {
  x
} from "./chunk-ID7BZVKJ.js";
import {
  t as t2
} from "./chunk-ELIP33PA.js";
import "./chunk-6KWQBHB5.js";
import "./chunk-R55Z74SX.js";
...
import {
  ...
  ne,
  t
} from "./chunk-KS7HTIT5.js";
import "./chunk-EO44SAIJ.js";
import "./chunk-OG7E7GTZ.js";
import "./chunk-6H5LPMXM.js";
import "./chunk-2B5FSXOQ.js";
import "./chunk-XOEKBFCR.js";
import "./chunk-ML4HKWNF.js";
...
import "./chunk-TS4CV3IQ.js";
import "./chunk-C3NZVEQ4.js";
  ...
  constructor(e11) {
    super(e11), this._pendingPromises = new t2(), this._fetchFeaturesController = null, this._highlightPromises = { "highlight-active-feature": null, "highlight-selected-feature": null }, this._selectedClusterFeature = null, this.actions = new i5(), this.activeFeature = null, this.autoCloseEnabled = false, this.browseClusterEnabled = false, this.content = null, this.defaultPopupTemplateEnabled = false, this.featurePage = null, this.featuresPerPage = 20, this.featureMenuOpen = false, this.featureMenuTitle = null, this.featureViewModelAbilities = null, this.featureViewModels = [], this.highlightEnabled = true, this.includeDefaultActions = true, this.initialDisplayMode = "feature", this.selectedClusterBoundaryFeature = new d2({ symbol: new m2({ outline: { width: 1.5, color: "cyan" }, style: "none" }) }), this.title = null, this.updateLocationEnabled = false, this.view = null, this.visible = false, this.zoomFactor = 4, this.zoomToLocation = null, this._debouncedLocationUpdate = k((async (e12) => {
      ...
      if (i6 && "mesh" !== i6 && t5 && s4 && this.selectedFeature) if ("point" !== i6) try {
        ...
        i7 = O2(i7, t5), G || (G = await Promise.all([await import("./intersectsOperator-YV5C3LK6.js"), await import("./proximityOperator-X2AC6XFS.js")]));
        const [a8, n8] = G;
        if (!a8.execute(i7, s4)) {
...
var H2 = class extends n3(O) {
  ...
  loadDependencies() {
    return Promise.all([e7(), c2({ action: () => import("./calcite-action-ZW5JRT4S.js"), "action-bar": () => import("./calcite-action-bar-YCQ6RO2J.js"), "action-group": () => import("./calcite-action-group-LHAJIDIU.js"), button: () => import("./calcite-button-WQ6F74AV.js"), icon: () => import("./calcite-icon-RQB3CSRL.js"), flow: () => import("./calcite-flow-LVXSRWRB.js"), "flow-item": () => import("./calcite-flow-item-ZEQCQXLA.js"), list: () => import("./calcite-list-ZYAYHYM6.js"), "list-item": () => import("./calcite-list-item-44W65BIP.js"), "list-item-group": () => import("./calcite-list-item-group-YCFCOJJK.js"), loader: () => import("./calcite-loader-TWEQLYHA.js") })]);
  }
  destroy() {
...
//# sourceMappingURL=Popup-7HGQTWDI.js.map
