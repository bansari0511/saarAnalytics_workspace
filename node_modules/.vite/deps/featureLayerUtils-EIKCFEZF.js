...
import {
  l,
  n
} from "./chunk-3AC2YVSF.js";
import {
  o
} from "./chunk-NPBOPMAJ.js";
import {
  E,
  c,
  l as l2,
...
async function H(e) {
  ...
  e.forEach((({ type: e2 }) => {
    switch (l(e2)) {
      case "CatalogLayer":
        r.push(import("./CatalogLayer-A7H63NJ4.js").then(((e3) => e3.default)));
        break;
      case "FeatureLayer":
        r.push(import("./FeatureLayer-OXUDZSMH.js").then(((e3) => e3.default)));
        break;
      case "OrientedImageryLayer":
        r.push(import("./OrientedImageryLayer-ARHXSZHM.js").then(((e3) => e3.default)));
    }
  }));
...
//# sourceMappingURL=featureLayerUtils-EIKCFEZF.js.map
